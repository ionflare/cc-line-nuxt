...
const _dffee458 = () => import('../pages/mailbox/index.vue' /* webpackChunkName: "pages/mailbox/index" */).then(m => m.default || m)
...
const _44d32b6e = () => import('../pages/qr_booking/index_ori1.vue' /* webpackChunkName: "pages/qr_booking/index_ori1" */).then(m => m.default || m)
const _436b9e22 = () => import('../pages/qr_booking/my_queue.vue' /* webpackChunkName: "pages/qr_booking/my_queue" */).then(m => m.default || m)
...
export function createRouter () {
  return new Router({
    ...
    routes: [
		...
		{
			path: "/qr:booking/index:ori1",
			component: _44d32b6e,
			name: "qrbooking-indexori1"
		},
		{
			path: "/qr:booking/my:queue",
			component: _436b9e22,
			name: "qrbooking-myqueue"
		},
		{
			path: "/",
			component: _3927666f,
